    ...
    return (
        <div className='bg-purple-100  dark:bg-gray-800 py-20'>
            <div className='w-11/12 mx-auto'>
                <h1 className='text-4xl font-bold text-center mt-5 mb-2'  data-aos="fade-down">Top Contributors</h1>
                <p className='text-center mb-10' data-aos="fade-down" data-aos-delay="200">Meet our most active community members</p>

                <div className='grid grid-col-1 md:grid-cols-2 lg:grid-cols-3 gap-10 rounded-2xl'>
                    <div data-aos="fade-down" data-aos-delay="200" className=' bg-white dark:bg-gray-600 py-8 px-8 justify-center items-center rounded-2xl flex flex-col'>
                    ...
                    <div data-aos="fade-down" data-aos-delay="200" className=' bg-white dark:bg-gray-600 py-8 px-8 justify-center rounded-2xl items-center flex flex-col'>
