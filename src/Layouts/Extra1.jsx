            ...
            <div className='  py-20'>
                <div className='w-11/12 mx-auto'>
                    ...
                    <div className='grid grid-col-1 md:grid-cols-2 lg:grid-cols-3 gap-10 rounded-2xl'>
                        <div className='shadow-lg bg-blue-50 dark:bg-gray-800 text-blue-600 py-8 px-8 justify-center items-center rounded-2xl flex flex-col'>
                        ...
                        <div className='shadow-lg bg-purple-50 dark:bg-gray-800 text-purple-600 py-8 px-8 justify-center items-center rounded-2xl flex flex-col'>
                        ...
                        <div className='shadow-lg bg-green-50 dark:bg-gray-800  text-green-600 py-8 px-8 justify-center rounded-2xl items-center flex flex-col'>
