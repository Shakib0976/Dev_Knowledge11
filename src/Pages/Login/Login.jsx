        ...
        <div className="min-h-screen colorgp flex flex-col lg:flex-row items-center justify-center lg:mx-20 px-4 py-8 bg-gray-50 dark:bg-black">
            ...
            <div className="flex-1 hidden md:flex w-full  flex-col items-center justify-center text-center mb-2 lg:mb-0">
                ...
                <Lottie
                    ...
                    loop={true}
                    className="w-[300px] h-[300px] sm:w-[350px] sm:h-[350px] md:w-[400px] md:h-[400px] lg:flex hidden mt-6"
                />
            </div>

            {/* Right Section - Form */}
            <div className="w-full max-w-md p-2 lg:p-8 md:px-6 md:py-6 rounded-2xl shadow-[0_0_5px_rgba(110,69,226,0.5),_0_0_10px_rgba(136,211,206,0.3)] bg-gradient-to-br bg-white dark:bg-transparent border border-gray-200 dark:border-gray-700">
