            ...
            <div className='grid grid-cols-1  md:gap-10 gap-5 lg:gap-20 mb-10'>
                {loading ? (
                    Array.from({ length: 3 }).map((_, i) => (
                        <div key={i} className="w-full mx-auto max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl rounded-xl border border-gray-300 dark:border-gray-700 p-4 animate-pulse bg-white dark:bg-neutral-900">
                            <div className="flex items-center space-x-4 mb-4">
                                ...
                                <div className="flex-1 space-y-2">
                                    ...
                                    <div className="h-3 w-1/3 bg-gray-300 rounded dark:bg-gray-700"></div>
                                </div>
                            </div>
                            <div className="w-full h-64 bg-gray-300 rounded dark:bg-gray-700 mb-4"></div>
                            <div className="space-y-2">
                                <div className="h-5 w-3/4 bg-gray-300 rounded dark:bg-gray-700"></div>
                                <div className="h-3 w-full bg-gray-300 rounded dark:bg-gray-700"></div>
                                <div className="h-3 w-5/6 bg-gray-300 rounded dark:bg-gray-700"></div>
                            </div>
                            <div className="flex space-x-2 mt-4">
                                <div className="h-6 w-16 bg-gray-300 rounded-full dark:bg-gray-700"></div>
                                <div className="h-6 w-16 bg-gray-300 rounded-full dark:bg-gray-700"></div>
                            </div>
                        </div>
                    ))
